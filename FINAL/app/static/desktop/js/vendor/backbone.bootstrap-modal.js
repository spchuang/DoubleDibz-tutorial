...
define([
  ...
  var template = _.template('\
    <div class="modal-dialog modal-dialog-center {{dialogClass}}"><div class="modal-content">\
    <% if (title) { %>\
    ...
    <% } %>\
    <div class="modal-body"><div class="modal-flash"></div><div class="modal-body-content">{{content}}</div></div>\
    <% if (showFooter) { %>\
  ...
  var Modal = Backbone.View.extend({
    ...
    events: {
      'click .modal-close-btn': function(event) {
    ...
    render: function() {
      ...
      var $content = this.$content = $el.find('.modal-body-content')
